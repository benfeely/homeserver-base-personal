...
| ------------------------------ | ----------- | -------------------------------- | ------------------------------------------------- |
| OPNsense Router                | 10.10.10.1  | router.home.banjonet.com         | Network gateway and firewall on Protectli Proxmox |
...
- **Static Reservations**: All infrastructure devices and services have DHCP reservations in OPNsense
- **DHCP Ranges**:
...
1. **Internal DNS**: OPNsense DNS resolver for local resolution
...
- **VLAN Implementation**: All subnets are implemented as VLANs over the same physical network infrastructure:
  - OPNsense running on Protectli Vault handles routing between VLANs
